...
import co.com.screenplay.project.questions.ValidateElementsTestBtn;
...
public class OpenWebStepDefinition {
    ...
    public void youWantToValidateTheFunctionOfTheElementCard() {
    ...
    public void randomlySelectOneOfTheSubfunctions() {
    ...
    public void TheNameOfTheChosenOptionWillBeDisplayedInTheHeader() {
        ...
        theActorInTheSpotlight().should(seeThat(ValidateElementsTestBtn.witchParams(validateText)));
    }
}
